...
|---|-----|---------|-------|------------|
| 0 | Doppia-fee phantom | 🔴 era CRITICA | ✅ RISOLTO | 10mag2026 (riga 9069-9075) |
| 1 | `_place_order` PLACEHOLDER vuoto | 🔴 MORTALE in LIVE | 🔴 APERTO | — |
| 2 | Phantom Sup vs Comparto sulla SOGLIA_BASE | 🟠 ALTA | 🔴 APERTO | — |
| 3 | NervosismoEngine DISATTIVATO | 🟠 ALTA | 🔴 APERTO | — |
| 4 | Phantom Sup scrive globale per problema locale | 🟠 ALTA | 🔴 APERTO | — |
...
| 9 | Veritas verdetto FUOCO_SHORT falso allarme | 🟢 OSSERV. | 🔴 APERTO | — |
| 10 | Set_param chiamati su dict vuoto (codice morto) | 🟢 INCOERENZA | 🔴 APERTO | (legato a #2/#3) |
| 11 | Cap 5 phantom aperti | 🟡 MEDIA | 🔴 APERTO | — |
| 12 | `MIN_PNL_EDGE` costante morta | 🟢 BASSA | 🔴 APERTO | — |

**Totale:** 1 risolto, 12 aperti.
