...
- VIETATO: blocca_entry con solo "regime"+"volatility" senza "trend" — blocca anche FORTE|BASSA|UP WR 78%
- OGNI blocca_entry DEVE avere "trend" nel trigger — SIDEWAYS, UP, o DOWN
- MAI bloccare RANGING+ALTA senza trend=SIDEWAYS specificato"""
