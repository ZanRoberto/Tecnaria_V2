...
_ORACLE_KNOW = (
    "OVERTOP BASSANO V15 — CONOSCENZA COMPLETA\n\n"
    "IDENTITA: Bot paper trading BTC/USDC su Render. Flask+SQLite+Python. Repo: Tecnaria_V2.\n\n"
    "COMPONENTI CORE:\n"
    "1. CampoGravitazionale: SeedScorer 4 componenti (seed 0-100), RSI 14, MACD. Entry se score >= soglia (base 55, min 52). _ta_sample_rate=5 (fixato da 50).\n"
    "2. MatrimonioIntelligente: 7 tipi - STRONG_BULL 85%WR, MEDIUM_BULL 70%, CAUTIOUS 60%, WEAK_NEUTRAL 45%, TRAP 5%, PANIC 15%, STRONG_MED 75%. 4 divorce triggers.\n"
    "3. OracoloDinamico: fingerprint WR memory decay 0.95. DEBOLE|ALTA|SIDEWAYS=WR 12%=TOSSICO.\n"
    "4. CapsuleIntelligente: sistema immunitario predittivo. Postura: ALLERTA/OFFENSIVO/DIFENSIVO/NEUTRO. 8 capsule attive.\n"
    "5. PhantomTracker: simula trade non eseguiti. PROBLEMA: Phantom Supervisor autoirrigidisce soglia ogni 60s con 0 trade = loop infinito.\n"
    "6. SuperCervello: predice direzione, carica LONG 0.516 / SHORT 0.913.\n"
    "7. AIBridge (Il Generale): analisi ogni 5s, comandi FORZA_ENTRY/ABBASSA_SOGLIA/BLOCCA_SC/RESET_PESI.\n"
    "8. RegimeDetector: RANGING/EXPLOSIVE/TRENDING_BULL/TRENDING_BEAR + confidence%.\n\n"
    "STATO (20 aprile 2026): 0 trade. BTC $75465. Regime RANGING 27%. VETO_TOSSICO INVALICABILE su DEBOLE|ALTA|SIDEWAYS. "
    "Phantom Supervisor irrigidisce in loop. Fix: sample_rate 50->5, warmup 35->20, BOOT_GUARD 14+10s. SHORT disabilitato.\n\n"
    "PROBLEMI APERTI:\n"
    "P1-CRITICO: Phantom Supervisor loop autoirrigidimento con 0 trade\n"
