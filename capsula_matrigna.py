...
class CapsulaMatrigna:
    ...
    def _calcola_stato_capsula(self, cap: Dict[str, Any]) -> Tuple[str, str]:
        ...
        # ── Fase 2: appena finiti gli esperimenti (n == BUDGET) ──
        # Soglia sopravvivenza: almeno 1 WIN su 3
        if n == self.BUDGET_ESPERIMENTI_INIZIALE:
        ...
        # ── Fase 3: tra BUDGET e SAMPLE_MATURAZIONE ──
        if n < self.SAMPLE_MATURAZIONE:
            # Stato precedente CONGELATA: serve trend di recupero
